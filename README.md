...
`tests/browser/check_plugin_registry.py` runs against the shipped defaults. A
bookmark to a view of a category that is off falls back to the first view of the
menu.

...
def _build_metrics_summary(*, session: ReplaySession, traces: list[TraceRecord]) -> dict[str, object]:
    ...
    return {
        ...
        "metrics": {
            ...
            "engine_queue_wait_ms": _summarize_metric(_metric_values(translated_traces, "engine_queue_wait_ms")),
            "backend_inference_wall_ms": _summarize_metric(_metric_values(translated_traces, "backend_inference_wall_ms")),
            "engine_total_wall_ms": _summarize_metric(_metric_values(translated_traces, "engine_total_wall_ms")),
            "engine_outside_backend_wall_ms": _summarize_metric(_metric_values(translated_traces, "engine_outside_backend_wall_ms")),
            "pool_total_wall_ms": _summarize_metric(_metric_values(translated_traces, "pool_total_wall_ms")),
